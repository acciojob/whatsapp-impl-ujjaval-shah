...
public class WhatsappController {
    ...
    public String createUser(String name, String mobile) throws Exception {
        ...
        if (whatsappService.alreadyExist(mobile)) throw new Exception("User already exists");
    ...
    public int sendMessage(Message message, User sender, Group group) throws Exception{
        ...
        if (!whatsappService.groupExists(group))
            throw new Exception("Group does not exist");
        if (!whatsappService.memberOfAGroup(group, sender))
    ...
    public String changeAdmin(User approver, User user, Group group) throws Exception{
        ...
        if (!whatsappService.groupExists(group))
            throw new Exception("Group does not exist");
        if (!whatsappService.isAdmin(group, approver))
            throw new Exception("Approver does not have rights");
        if (!whatsappService.memberOfAGroup(group, user))
